 ...
 <div class="row">
   ...
   <div class="col-4">
     <div class="card">
       <img src="imgB/1.jpg" alt="Titulo">

      <div class="card-body">
        <span>Batido de Limon</span>
...
<br> </br>
   ...
   <div class="col-4">
     <div class="card">
       <img src="imgB/2.png" alt="Titulo">

      <div class="card-body">
        <span>Batido de Pistache</span>
   ...
   <div class="col-4">
     <div class="card">
       <img src="imgB/3.png" alt="Titulo">

      <div class="card-body">
        <span>Batido de Frambruesa</span>
   ...
   <div class="col-4">
     <div class="card">
       <img src="imgB/4.png" alt="Titulo">

      <div class="card-body">
        <span>Batido de Mora</span>
        <h5 class="card-title">$35000</h5>
        <p class="card-text">Descripcion</p>
      ...
      <div class="col-4">
        <div class="card">
          <img src="imgB/5.png" alt="Titulo">

         <div class="card-body">
           <span>Batido de Fresa</span>
           <h5 class="card-title">$35000</h5>
           <p class="card-text">Descripcion</p>
         ...
         <div class="col-4">
           <div class="card">
             <img src="imgB/6.png" alt="Titulo">

            <div class="card-body">
              <span>Batido de Temporada con proteina</span>
              <h5 class="card-title">$35000</h5>
              <p class="card-text">Descripcion</p>
