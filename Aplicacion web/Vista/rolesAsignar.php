...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <section id=formulario>
      ...
      <div class="login">
        <form class=""  method="post">
          ...
          <p>
              <p style="color: #000000">Id del usuario</p>
              <input type="text" id="idUsuario" value="" placeholder="Digite el id del usuario" title="Campo requerido" required>
          </p>
          ...
          <p>
              ...
              <button type="button" name="button" id="AsignarRol" >Asignar</button>
    ...
    <script src="js/operaciones3.js" charset="utf-8"></script>
