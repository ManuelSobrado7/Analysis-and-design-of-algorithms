     ...
     <nav class="navbar navbar-expand-lg navbar-light bg-light">
       ...
       <div class="collapse navbar-collapse" id="navbarNav">
         ...
         <ul class="navbar-nav">
           ...
           $consulta1 = mysqli_query($conexion,'select id from logeado');
           $consulta = mysqli_fetch_array($consulta1);
           $consulta2 = implode(',',$consulta);

           $id = mysqli_query($conexion, "select agregar from modulos where usuario = '".$consulta2."' ");
           $id2 = mysqli_fetch_array($id);
           $id3 = implode(',',$id2);

           $idE = mysqli_query($conexion, "select eliminar from modulos where usuario = '".$consulta2."' ");
           $idE2 = mysqli_fetch_array($idE);
           $idE3 = implode(',',$idE2);

           $idED = mysqli_query($conexion, "select editar from modulos where usuario = '".$consulta2."' ");
           $idED2 = mysqli_fetch_array($idED);
           $idED3 = implode(',',$idED2);

           $idL = mysqli_query($conexion, "select listar from modulos where usuario = '".$consulta2."' ");
           $idL2 = mysqli_fetch_array($idL);
           $idL3 = implode(',',$idL2);
           ...
           <?php
            ...
            ?>
            <li class="nav-item">
              <a style="color : blue" class="nav-link" href="agregarr.php">Agregar Productos</a>
            </li>
           <?php
         }
          ?>
          ...
          <?php if ($idE3 == 0 ) { ?>
            <?php
             ...
             ?>
             <li class="nav-item">
               <a style="color : blue" class="nav-link" href="eliminar.php">Eliminar Productos</a>
             </li>
            <?php
          }
           ?>
           ...
           <?php if ($idED3 == 0 ) { ?>
             <?php
              ...
              ?>
              <li class="nav-item">
                <a style="color : blue" class="nav-link" href="editar.php">Editar Productos</a>
              </li>
             <?php
           }
            ?>
            ...
            <?php if ($idL3 == 0 ) { ?>
              <?php
               ...
               ?>
               <li class="nav-item">
                 <a style="color : blue" class="nav-link" href="Buscar.php">Buscar Productos</a>
               </li>
              <?php
            }
             ?>
             ...
             <li class="nav-item active">
               <a style="color : blue" class="nav-link" href="Login.php">Cerrar Sesion <span class="sr-only">(current)</span></a>
             </li>
